...
function setup() {
	...
	packageBody = Bodies.circle(width/2 , 200 , 5 , {restitution:1.4, isStatic:true});
...
function draw() {
  ...
  rect(packageBody.position.x,packageBody.position.y,packageBody.width,packageBody.height)
